...
const route = (name: string, params?: any) => {
    const routes: any = {
        ...
        'asistencias.update': (id: number) => `/asistencias/${id}`,
    };
...
export default function Edit({ asistencia, empleados }: Props) {
    const { data, setData, put, processing, errors } = useForm({
        empleado_id: asistencia.empleado_id.toString(),
                    ...
                    <div className="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                        <div className="p-6">
                            <div className="flex items-center mb-6">
                                ...
                                <h2 className="text-2xl font-bold text-gray-800 ml-4">Editar Asistencia</h2>
                            </div>
